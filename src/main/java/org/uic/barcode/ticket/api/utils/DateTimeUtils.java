...
public class DateTimeUtils {
    ...
    public static Long getDateDifference(Date issuingDate, Date localDate) {
        ...
        if (issuingDate == null || localDate == null)
            return null;
    ...
    public static Long getDateDifferenceLocal(Date referenceDate, Date localDate) {
        ...
        if (referenceDate == null || localDate == null)
            return null;
     ...
     *         the offset needs to be added to local time to get the UTC time (UTC =
     *         local + offset)
     */
    public static Long getUTCoffset(Date local) {
         ...
         * in this
         * time zone. Because this value is not affected by daylight saving time, it is
         * called raw offset.
         * If an underlying TimeZone implementation subclass supports historical GMT
         * offset changes, the method
         * returns the raw offset value of the current date. In Honolulu, for example,
         * its raw offset
